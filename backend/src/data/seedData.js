// Arquivo de seeds para popular o banco de dados com dados iniciais (Fallback para testes e desenvolvimento está no frontend)
...
export const SEEDED_ENROLLMENTS = [
    {
        id: 'enroll_01',
        userId: 'user_aluno2',
